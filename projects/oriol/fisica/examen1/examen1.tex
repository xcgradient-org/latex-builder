...
% ================================================================
% PÀGINA 1: COBERTA I PUNTUACIÓ
% ================================================================
\begin{center}
  \vspace*{1.5cm}
  {\Huge\bfseries Examen de Cinemàtica}\\[14pt]
  {\Large Física · 4t ESO \quad·\quad Escola Cervetó}\\[18pt]
  \hrule height 2pt
  \vspace{1.5cm}
\end{center}
...
\begin{tabularx}{\textwidth}{|X|}
  \hline
  \rule{0pt}{30pt}\textbf{\Large Nom i cognoms:}\\[20pt]
  \hline
\end{tabularx}
...
\begin{center}
  {\Huge
  \framebox[2.2cm]{\rule{0pt}{35pt}} + 
  \framebox[2.2cm]{\rule{0pt}{35pt}} + 
  \framebox[2.2cm]{\rule{0pt}{35pt}} + 
  \framebox[2.2cm]{\rule{0pt}{35pt}} + 
  \framebox[2.2cm]{\rule{0pt}{35pt}} + 
  \framebox[2.2cm]{\rule{0pt}{35pt}} = 
  \framebox[4cm]{\rule{0pt}{50pt}} 
  \textbf{\fontsize{40}{48}\selectfont / 10}
  }
\end{center}
...
\begin{enumerate}[label=\textbf{\alph*)}]
  ...
  \item Aconseguirà Bohr retornar-li els papers abans que marxi el tren?
