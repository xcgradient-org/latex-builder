...
\begin{center}
  \vspace*{-10pt}
  {\Huge\bfseries Examen de Cinemàtica}\\[10pt]
  {\Large Física · 4t ESO \quad·\quad Escola Cervetó \quad·\quad Prof.\ Oriol Farrés}\\[15pt]
  \hrule height 2pt
  \vspace{10pt}
\end{center}
...
\begin{tabularx}{\textwidth}{|X|}
  \hline
  \rule{0pt}{20pt}\textbf{\large Nom i cognoms:}\\[10pt]
  \hline
\end{tabularx}
...
\begin{itemize}[leftmargin=1.5em, itemsep=12pt, parsep=6pt]
...
\begin{tabularx}{\textwidth}{|*{7}{>{\centering\arraybackslash}X|}}
  ...
  \hline
  \rule{0pt}{15pt} 0 & 2 & 0 & 0 & 0 & 0 & 0 \\[10pt]
  \hline
  \rule{0pt}{15pt} 0 & 7 & 5 & 0 & 0 & 0 & 0 \\[10pt]
  \hline
  \rule{0pt}{15pt} & & & & & & \\[10pt]
  \hline
  \rule{0pt}{15pt} & & & & & & \\[10pt]
...
\begin{tabularx}{\textwidth}{|X r|}
  \hline
  \rule{0pt}{70pt} \textbf{\Huge Nota final:} & \fontsize{45}{54}\selectfont \hspace{4cm} \textbf{/ 10} \\[35pt]
  \hline
\end{tabularx}
...
\begin{enumerate}[label=\textbf{\alph*)}]
  \item Escriu les equacions de posició $x(t)$ per a cadascun dels dos trams del moviment.
