...
This section examines how individual design factors influence CIO, averaging across all other dimensions.
Figure~\ref{fig:linear-cio-univariate} summarizes the univariate CIO trends for the linear-regression scenarios.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.96\textwidth]{figures/parts/03_Regression/03_Linear_Results/linear_cio_univariate.png}
...
\end{equation}
In the sequential synthesis pipeline used here, the response variable $Y$ is generated last, conditional on all previously generated predictors. Therefore, any distortions accumulated during the generation of $\mathbf{X}$ can also propagate to the final synthetic outcome.
...
\begin{figure}[p]
    \centering
    \includegraphics[width=\textwidth,height=0.88\textheight,keepaspectratio]{figures/parts/03_Regression/03_Linear_Results/linear_cio_by_method.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/parts/03_Regression/03_Linear_Results/linear_cio_vs_design_correlation_spearman.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.92\textwidth]{figures/parts/03_Regression/03_Linear_Results/linear_plot_bias_ratio_by_method.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.92\textwidth]{figures/parts/03_Regression/03_Linear_Results/linear_plot_ci_width_ratio_by_method.png}
