...
\begin{figure}[p]
    \centering
    \includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{figures/parts/03_Regression/03_Linear_Results/linear_cio_by_method.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.82\textwidth]{figures/parts/03_Regression/03_Linear_Results/linear_plot_bias_ratio_by_method.png}
