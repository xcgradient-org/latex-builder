...
\begin{itemize}
    ...
    \item \textbf{Relative Generator Performance:} In scenarios where the data-generating process is compatible with the assumed parametric form, parametric synthesis (Normal, LogReg) generally performs better than CART for inferential preservation.
\end{itemize}
...
For researchers whose data aligns reasonably well with standard parametric assumptions (linear, normal, logistic), \textbf{Parametric Generators} are generally the safer choice for preserving inferential results.
...
Researchers should prioritize generators that match their intended analytical model. If a linear regression is planned for the final analysis, a linear (Normal) synthesis arm is generally the most appropriate baseline choice.
