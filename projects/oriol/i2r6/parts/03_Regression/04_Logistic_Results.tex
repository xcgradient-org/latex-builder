...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/parts/03_Regression/04_Logistic_Results/logistic_cio_univariate.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/parts/03_Regression/04_Logistic_Results/logistic_cio_by_method.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/parts/03_Regression/04_Logistic_Results/logistic_cio_vs_design_correlation_spearman.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/parts/03_Regression/04_Logistic_Results/logistic_plot_bias_ratio_by_method.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/parts/03_Regression/04_Logistic_Results/logistic_plot_ci_width_ratio_by_method.png}
