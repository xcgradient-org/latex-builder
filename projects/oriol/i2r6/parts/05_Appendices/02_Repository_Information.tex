...
\begin{itemize}
    ...
    \item \textbf{Original Work Base:} Xinnuo Chen (2025)
\end{itemize}
...
\begin{quote}
    \textbf{Xinnuo Chen} (2025). \textit{TFG-EST: Synthetic Data Generation and Clustering Analysis}. Universidad de Barcelona.
\end{quote}
