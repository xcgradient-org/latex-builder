...
\begin{figure}[H]
  ...
  \caption[PCA Projection on Normal Distribution]{\textbf{PCA Projection: Normal Distribution ($N=1000, k=2$).} Comparison of Real (Top) vs. Synthetic (Bottom).}
...
\begin{figure}[H]
  ...
  \caption[PCA Projection on Gamma Distribution]{\textbf{PCA Projection: Gamma Distribution ($N=1000, k=2$).} Comparison of Real (Top) vs. Synthetic (Bottom).}
  \label{fig:pca_gamma}
  \source{Compiled by the author}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption[t-SNE Projection on Normal Distribution]{\textbf{t-SNE Projection: Normal Distribution.} Comparison of Real (Top) vs. Synthetic (Bottom).}
...
\begin{figure}[H]
  ...
  \caption[t-SNE Projection on Gamma Distribution]{\textbf{t-SNE Projection: Gamma Distribution.} Comparison of Real (Top) vs. Synthetic (Bottom).}
