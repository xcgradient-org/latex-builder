...
This part of the thesis extends the work of Xinnuo Chen \cite{chen2025} by systematically comparing how well K-Means and Agglomerative Hierarchical Clustering perform on CART-generated synthetic data.
...
\begin{itemize}
  ...
  \item \textbf{Chapter 5: Conclusions} synthesizes the clustering findings, highlighting the shared sensitivity of both clustering methods to synthetic geometric distortion and identifying the practical implications for structural utility evaluation.
\end{itemize}
